                                ...
                                @foreach ($usersPartnership as $detail)
                                    <tr class="align-middle" data-toggle="collapse" class="accordion-toggle">
                                        ...
                                        <td class="text-nowrap">
                                            {{ $detail->name_of_partnership ? $detail->name_of_partnership : '--' }}
                                        </td>
...
<script>
    ...
    function openPartnershipNoteModal(itemId) {
        ...
        $.ajax({
            url: adminUrl + '/user/forms/statusview' + '?for=note&formtype=partnership&id=' + itemId,
            type: 'GET',
    ...
    function openPartnershipApproveModal(itemId) {
        ...
        $.ajax({
            url: adminUrl + '/user/forms/statusview' + '?for=approve&formtype=partnership&id=' + itemId,
            type: 'GET',
            success: function(data) {
