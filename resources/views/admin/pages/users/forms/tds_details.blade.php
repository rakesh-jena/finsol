                            ...
                            @if ($usersTds)
                                @foreach ($usersTds as $detail)
                                    <tr class="align-middle" data-toggle="collapse" class="accordion-toggle">
                                        ...
                                        <td><a
                                                href="{{ url('admin/user/forms/details/tds/' . $detail->id) }}">Details</a>
                                        </td>
                                        <td>
...
<script>
    ...
    function openTdsNoteModal(itemId) {
        ...
        $.ajax({
            url: adminUrl + '/user/forms/statusview' + '?for=note&formtype=tds&id=' + itemId,
            type: 'GET',
    ...
    function openTdsApproveModal(itemId) {
        ...
        $.ajax({
            url: adminUrl + '/user/forms/statusview' + '?for=approve&formtype=tds&id=' + itemId,
            type: 'GET',
            success: function(data) {
