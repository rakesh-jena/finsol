...
<div class="card mb-3">
    ...
    <div class="card-body bg-light row">
        ...
        <div class="col-lg-6 mb-3"> <label class="form-label" for="email1">Email : </label>{{$esicDetails->esic_email}}
        </div>
...
<div class="card mb-3">
    ...
    <div class="card-body bg-light">
        ...
        ['documents'=> $esicDocuments,'form_type'=>'Esic', 'details'=>$esicDetails])
...
<div class="card mb-3">
    ...
    <div class="card-body bg-light">
        @include('admin.pages.users.forms.profile.common',
        ['documents'=> $esicSignatoryDocuments,'form_type'=>'Esic', 'details'=>$esicDetails])
