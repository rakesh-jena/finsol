...
<div class="card mb-3">
    ...
    <div class="card-body bg-light">
        ...
        ['documents'=> $partnershipDocuments,'form_type'=>'Partnership', 'details'=>$partnershipDetails])
...
<div class="card mb-3">
    ...
    <div class="card-body bg-light">
        ...
        @include('admin.pages.users.forms.profile.common',
        ['documents'=> $partnershipPartnerDocuments,'form_type'=>'Partnership', 'details'=>$partnershipDetails])
