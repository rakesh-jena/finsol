...
<div class="card mb-3">
    ...
    <div class="card-body bg-light row">
        ...
        <div class="col-lg-6 mb-3"> <label class="form-label" for="email1">Email : </label>{{$minutesDetails->email_id}}
        </div>
...
<div class="card mb-3">
    ...
    <div class="card-body bg-light">
        ...
        ['documents'=> $minutesDocuments,'form_type'=>'Minutes', 'details'=>$minutesDetails])
    </div>
