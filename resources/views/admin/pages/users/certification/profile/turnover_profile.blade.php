...
<div class="turnoverrd mb-3">
    ...
    <div class="turnoverrd-body bg-light row">
        ...
        <div class="col-lg-6 mb-3"> <label class="form-label" for="email1">Email : </label>{{$turnoverDetails->email_id}}
        </div>
...
<div class="turnoverrd mb-3">
    ...
    <div class="turnoverrd-body bg-light">
        ...
        ['documents'=> $turnoverDocuments,'form_type'=>'Turnover', 'details'=>$turnoverDetails])
    </div>
