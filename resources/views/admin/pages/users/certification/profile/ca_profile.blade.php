...
<div class="card mb-3">
    ...
    <div class="card-body bg-light row">
        <div class="col-lg-6 mb-3"> <label class="form-label" for="gst-type">Name of Compaany :
            </label>{{$caDetails->name_of_company}}</div>
        ...
        <div class="col-lg-6 mb-3"> <label class="form-label" for="email1">Email : </label>{{$caDetails->email_id}}
        </div>
...
<div class="card mb-3">
    ...
    <div class="card-body bg-light">
        ...
        ['documents'=> $caDocuments,'form_type'=>'Ca', 'details'=>$caDetails])
    </div>
