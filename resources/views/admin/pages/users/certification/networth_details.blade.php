@if($usersNetworth) 
<div class="row">  <h5>NETWORTH Form Details</h5>
                            <div class="col-12">
                                <div id="tableExample"
                                        ...
                                        <table class="table table-bordered table-striped fs--1 mb-0">
                                            ...
                                            <tbody class="list">
                                                ...
                                                <tr class="align-middle">
                                                    ...
                                                    <td><a href="{{ url('admin/user/certification/details/networth/'.$detail->id) }}">Details</a></td>
                                                    <td>
                                                        @if($detail->status == 2)
                                                        <div><span
                                                        ...
                                                        <div><span
                                                         ...
                                                         <form action="{{ url('admin/user/certification/additional/file/' . $detail->user_id) }}" method="POST">
                                                                                    @csrf
                                                        ...
                                                        <span
                                                            class="badge badge rounded-pill d-block p-2 badge-subtle-success">Approved<span
                                                                ...
                                                                @if($detail->approved_img!="")        
                                                                     <form action="{{ url('admin/user/certification/approved/file/' . $detail->user_id) }}" method="POST">
                                                                                    @csrf
                                                                                        <input type="hidden" name="form_type" value="Networth">
                                                    ...
                                                    <td colspan=6 style="display:flex;">
                                                        <span class="btn btn-info ml-1 mb-1 btn-sm" title="Add Note"
                                                           ...
                                                           href="{{ url('certification/statusview/'.$detail->id) }}" data-target="#myNetworthNoteModal">
                                                            Note<span class="glyphicon glyphicon-eye-open ms-1"></span>
                                                        </span> 

 
                                                         <span class="btn btn-success ml-1 mb-1 btn-sm  " title="Change Status"
                                                            type="button" data-toggle="modal"  onclick="openNetworthApproveModal({{ $detail->id }})"
