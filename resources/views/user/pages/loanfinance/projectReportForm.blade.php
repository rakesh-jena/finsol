                ...
                <div class="card-body">
                    ...
                    <form class="needs-validation" novalidate="novalidate" action="{{ route('projectReport.register') }}"
                        ...
                        <div class="mt-1 row g-2">
                            <div class="col-4">
                                <div class="mb-3">
                                    <label class="form-label" for="bootstrap-wizard-validation-wizard-email">Name for
                                        Company
                                    </label><input class="form-control" type="text" pattern="[a-zA-Z\s]+" name="name_of_company"
                            ...
                            <div class="col-4">
                                <div class="mb-3">
                                    <label class="form-label" for="form-wizard-progress-wizard-addregnum">Mobile
                                        ...
                                        value="{{ Auth::user()->mobile }}" maxlength="10" maxlength="10" placeholder="Enter Mobile Number"
                            ...
                            <div class="col-4">
                                <div class="mb-3">
                                    <label class="form-label" for="form-wizard-progress-wizard-addregnum">Address of the
                                        Project</label>
                                    <input class="form-control" type="text" name="project_address"
                                        placeholder="Enter Project Address" id="form-wizard-progress-wizard-addregnum" />
                            ...
                            <div class="col-4">
                                <div class="mb-3">
                                    ...
                                    <input class="form-control" required="" type="text" name="networth"
                                        placeholder="Enter Networth" id="form-wizard-progress-wizard-addregnum" />
