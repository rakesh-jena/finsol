                ...
                <div class="card-body">
                    ...
                    <form class="needs-validation" novalidate="novalidate" action="{{ route('estimated.register') }}"
                        ...
                        <div class="mt-1 row g-2">
                            ...
                            <div class="col-4">
                                <div class="mb-3">
                                    <label class="form-label" for="form-wizard-progress-wizard-addregnum">Proposed Loan
                                        Amount
                                        (TL/CC)</label>
                                    <input class="form-control" required="" type="text" name="proposed_amount"
                                        placeholder="Enter Proposed loan" id="form-wizard-progress-wizard-addregnum" />
