                        ...
                        <div class="mt-1 row g-2">
                            ...
                            <div class="col-6">
                                <div class="mb-3">
                                    ...
                                    </label><input class="form-control" type="text" name="shop_name"
                                        placeholder="Name for SHOP" required="required" />
                            ...
                            <div class="detailsmargin card-header d-flex flex-between-center bg-light py-2">
                                <h6 class="detailspadding mb-0">Upload documents required for Shop & Establishment</h6>
                            </div>
                            <div class="row g-2 ">
