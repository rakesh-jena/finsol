                        ...
                        <div class="card mb-3">
                            ...
                            <div class="card-body">
                                ...
                                <form class="needs-validation" novalidate="novalidate"
                                    action="{{ route('legalwork.register') }}"
                                    ...
                                    <div class="mt-1 row g-2">
                                        ...
                                        <div class="col-4">
                                            <div class="mb-3">
                                                <label class="form-label" for="form-wizard-progress-wizard-addregnum">Mobile
                                                    ...
                                                    type="text" name="mobile_number" maxlength="10"
                                        ...
                                        <div class="col-4">
                                            <div class="mb-3">
                                                <label class="form-label"
                                                    for="form-wizard-progress-wizard-addregnum">Registration Type</label>
                                                <select class="form-select" name="form_type" aria-label="Registration Type"
                                                    required>
                                        ...
                                        <div class="col-4">
                                            <div class="mb-3">
                                                <label class="form-label"
                                                    for="form-wizard-progress-wizard-addregnum">Subject</label>
                                        ...
                                        <div class="col-6">
                                            <div class="mb-3">
                                                <label class="form-label"
                                                    for="form-wizard-progress-wizard-addregnum">Description</label>
