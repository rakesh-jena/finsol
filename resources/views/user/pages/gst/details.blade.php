                                    ...
                                    <div class="row mt-6 g-3">
                                        @if (isset($userGstDetails))
                                            @if (
                                                ...
                                                <div class="col-lg-4">
                                                    <div onclick="location.href='{{ route('gst.business_status') }}'"
                                                        type="button">
                                        ...
                                        <div class="col-lg-4">
                                            <div onclick="location.href='{{ route('gst.existing_register_form') }}'"
                                                type="button">
                                                <div class="card card-span h-100">
                                                    <div class="roundlogobg topcurves">
                                    ...
                                    <div class="row mt-4 g-3">
                                        ...
                                        @if (isset($userGstApprovedDetails))
                                            @if ($userGstApprovedDetails->status == '4')
                                                <div class="col-lg-4">
                                                    <div onclick="location.href='{{ route('gst.copy_of_returns') }}'"
                                                        type="button">
                                                        <div class="card card-span h-100">
                                                            <div class="roundlogobg topcurves">
                                        ...
                                        @if (isset($userGstApprovedDetails))
                                            @if ($userGstApprovedDetails->status == '4')
                                                <div class="col-lg-4">
                                                    <div onclick="location.href='{{ route('gst.uploaddocuments') }}'"
                                                        type="button">
                                                        <div class="card card-span h-100">
                                                            <div class="roundlogobg topcurves">
