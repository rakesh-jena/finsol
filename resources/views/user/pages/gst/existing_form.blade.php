                                ...
                                <form class="needs-validation" novalidate="novalidate" action="{{ route('gst.existing') }}"
                                    ...
                                    <div class="mt-1 row g-2">
                                        ...
                                        <div class="col-4">
                                            <div class="mb-3">
                                                <label class="form-label"
                                                    for="form-wizard-progress-wizard-legalnamename">Trade
                                                    Name of
                                                    the
                                                    Business</label><input required="" class="form-control"
                                                    type="text" name="trade_name"
                                                    placeholder="Trade Name of Business" value="{{ old('trade_name') }}"
                                        ...
                                        <div class="col-4">
                                            <div class="mb-3">
                                                <label class="form-label"
                                                    for="bootstrap-wizard-validation-wizard-email">Email
                                                    of your
                                        ...
                                        <div class="col-4">
                                            <div class="mb-3">
                                                <label class="form-label" for="form-wizard-progress-wizard-addregnum">GST
                                                    Portal User
                                                    Id </label><input class="form-control" value="{{ old('gst_id') }}"
                                                    required="" type="text" name="gst_id"
                                        ...
                                        <div class="col-4">
                                            <div class="mb-3">
                                                <label class="form-label" for="form-wizard-progress-wizard-addregnum">GST
                                                    ...
                                                    type="password" name="gst_password"
