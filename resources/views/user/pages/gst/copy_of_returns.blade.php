                                            ...
                                            <div class="col-4">
                                                <div class="mb-3">
                                                    <label class="form-label"
                                                        for="form-wizard-progress-wizard-legalnamename">Select
                                                        GST Number</label>
                                                    <select name="gstnumber" class="form-select" id="gstSelect"
                                                        required="required" onChange="getFormType()"
                                            ...
                                            <div class="col-4">
                                                <div class="mb-3">
                                                    <label class="form-label"
                                                        for="form-wizard-progress-wizard-legalnamename">Select
                                                        Year</label>
                                                    <select class="form-select" required="required" id="gstyear"
                                        ...
                                        <div class="mt-1 row g-2">
                                            ...
                                            <div class="col-4">
                                                <div class="mb-3">
                                                    ...
                                                    <select class="form-select" id="gstmonth" name="month"
                                                        onchange="getQuarter()">
                                                        ...
                                                        @foreach ($items as $item)
                                                            <tr class="align-middle">
                                                                ...
                                                                <td class="text-nowrap">
                                                                    ...
                                                                    <form action="{{ route('copyofreturnsFile') }}"
                                                                        method="POST">
                                                                        @csrf
