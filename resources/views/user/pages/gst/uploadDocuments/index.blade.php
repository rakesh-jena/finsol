                        ...
                        <div class="card h-md-100 ecommerce-card-min-width">
                            ...
                            <section class="text-center">
                                <div class="container">
                                    <div class="row">
                                        <div class="col">
                                            <h1 style="color: #2a3468;" class="fs-2 fs-sm-4 fs-md-5">Upload <font
                                                    color="#ec465f">Documents
                                                </font>
                                            </h1>
                                                        ...
                                                        <div class="tab-pane preview-tab-pane active" role="tabpanel"
                                                            ...
                                                            <ul class="nav nav-pills" id="pill-myTab" role="tablist">
                                                                ...
                                                                <li class="nav-item"><a class="nav-link active"
                                                                        id="pill-home-tab" data-bs-toggle="tab"
                                                                        href="#pill-tab-home" role="tab"
                                                                        aria-controls="pill-tab-home"
                                                                        aria-selected="true">Monthly</a>
                                                                </li>

                                                                <li class="nav-item"><a class="nav-link"
                                                                        id="pill-profile-tab" data-bs-toggle="tab"
                                                                        href="#pill-tab-profile" role="tab"
