@if (count($userLabourDetails) > 0)<h4>LABOUR Details</h4>
            ...
            @if ($userLabourDetails)
                @foreach ($userLabourDetails as $key => $detail)
                    <tr class="align-middle" data-toggle="collapse" data-target="#{{ $detail->type . $key }}"
                        ...
                        <td class="text-nowrap">{{ isset($detail->name_of_labour) ? $detail->name_of_labour : '-' }}
                        </td>
