                                        ...
                                        <div class="col-6">
                                            <div class="mb-3">
                                                <label class="form-label"
                                                    for="bootstrap-wizard-validation-wizard-company">Name for FSSAI
                                                </label><input class="form-control" type="text" name="fssai_name"
                                                    placeholder="Name for FSSAI"
                                                    required="required" />
