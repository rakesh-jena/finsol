...
@section('content')
    <div class="d-flex mb-4">
        ...
        <div class="col">
            <h5 class="mb-0 text-primary position-relative"><span class="bg-200 dark__bg-1100 pe-3">Custom
                    Payment
                        ...
                        <div class="mt-1 row g-2">
                            <div class="col-6">
                                <div class="mb-3">
                                    ...
                                    </label><input class="form-control" type="text" name="name" placeholder="Name"
                            ...
                            <div class="col-6">
                                <div class="mb-3">
                                    <label class="form-label" for="form-wizard-progress-wizard-addregnum">Mobile
                                        ...
                                        name="mobile_number" value="{{ Auth::user()->mobile }}" maxlength="10" placeholder="Enter Mobile Number"
                            ...
                            <div class="col-6">
                                <div class="mb-3">
                                    <label class="form-label" for="bootstrap-wizard-validation-wizard-email">Payment For
                                    </label><input class="form-control" type="text" name="payment_for"
                                        placeholder="Payment For" required="required"
                            ...
                            <div class="col-6">
                                <div class="mb-3">
                                    <label class="form-label" for="bootstrap-wizard-validation-wizard-email">Amount
                                    </label><input class="form-control" type="number" name="amount"
                                        placeholder="Amount to be paid" required="required"
                                        id="bootstrap-wizard-validation-wizard-email" />
