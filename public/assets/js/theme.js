...
var wizardInit = function wizardInit() {
  ...
  wizards.forEach(function (wizard) {
    ...
    var inputLegalName = wizard.querySelector('[data-wizard-validate-legal-name]');
//  var inputPanName = wizard.querySelector('[data-wizard-validate-pan-name]');
    ...
    nextButton.addEventListener('click', function () {
      if ((!(inputEmail.value && validatePattern(emailPattern, inputEmail.value)) || !inputPassword.value || !inputConfirmPassword.value || !inputLegalName.value) && form.className.includes('needs-validation')) {
        form.classList.add('was-validated');
      } else {
        count += 1;
